    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-POSTapi-register">Register a new user and create a tenant.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-login">
                                <a href="#endpoints-POSTapi-login">Authenticate a user and generate an access token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-logout">
                                <a href="#endpoints-POSTapi-logout">Logout a user and revoke their access token.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-products">
                                <a href="#endpoints-GETapi-products">Retrieve all products belonging to the authenticated user.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-products--id-">Retrieve a specific product by ID.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-products--id-">Delete a product.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-orders">
                                <a href="#endpoints-GETapi-orders">Retrieve all orders belonging to the authenticated user's tenant.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-orders">
                                <a href="#endpoints-POSTapi-orders">Store a new order.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-orders--id-">
                                <a href="#endpoints-GETapi-orders--id-">Retrieve a specific order by ID.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-orders--id-">
                                <a href="#endpoints-PUTapi-orders--id-">Update an existing order.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-orders--id-">
                                <a href="#endpoints-DELETEapi-orders--id-">Delete an order.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-customers">
                                <a href="#endpoints-GETapi-customers">Retrieve all customers belonging to the authenticated user's tenant.</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-customers--id-">Retrieve a specific customer by ID.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-customers--id-">
                                <a href="#endpoints-PUTapi-customers--id-">Update an existing customer's details.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-customers--id-">
                                <a href="#endpoints-DELETEapi-customers--id-">Delete a customer.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-orders--id--status">
                                <a href="#endpoints-PUTapi-orders--id--status">Update the status of an order.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="endpoints">Endpoints</h1>
                                ...
                                <h2 id="endpoints-POSTapi-register">Register a new user and create a tenant.</h2>
...
<div class="bash-example">
    ...
    \"tenant_name\": \"hfqcoynlazghdtqtqxbaj\",
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="tenant_name"                data-endpoint="POSTapi-register"
...
<p>The value and <code>password</code> must match. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-login">Authenticate a user and generate an access token.</h2>
...
<p>Example: <code>O[2UZ5ij-e/dl4m{o,</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-logout">Logout a user and revoke their access token.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products">Retrieve all products belonging to the authenticated user.</h2>
...
<p>Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-GETapi-products--id-">Retrieve a specific product by ID.</h2>
...
<p>Example: <code>17</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-products--id-">Delete a product.</h2>
...
<p>The ID of the product. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-orders">Retrieve all orders belonging to the authenticated user&#039;s tenant.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-orders">Store a new order.</h2>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="POSTapi-orders"
               value="45"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>45</code></p>
                    ...
                    <h2 id="endpoints-GETapi-orders--id-">Retrieve a specific order by ID.</h2>
...
<p>The ID of the order. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-orders--id-">Update an existing order.</h2>
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="quantity"                data-endpoint="PUTapi-orders--id-"
               value="73"
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Example: <code>processed</code></p>
Must be one of:
<ul style="list-style-type: square;"><li><code>pending</code></li> <li><code>processed</code></li> <li><code>shipped</code></li> <li><code>delivered</code></li> <li><code>canceled</code></li></ul>
        </div>
        </form>

                    <h2 id="endpoints-DELETEapi-orders--id-">Delete an order.</h2>
...
<p>The ID of the order. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-customers">Retrieve all customers belonging to the authenticated user&#039;s tenant.</h2>
...
<p>Must not be greater than 20 characters. Example: <code>fuudtdsufvyvddqam</code></p>
                    ...
                    <h2 id="endpoints-GETapi-customers--id-">Retrieve a specific customer by ID.</h2>
...
<p>The ID of the customer. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-customers--id-">Update an existing customer&#039;s details.</h2>
...
<p>Must not be greater than 20 characters. Example: <code>fuudtdsufvyvddqam</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-customers--id-">Delete a customer.</h2>
...
<p>The ID of the customer. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-orders--id--status">Update the status of an order.</h2>
